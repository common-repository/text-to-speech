 ...
 *  Plugin URI: http://txt2speech.tk/
 *  Description: Javascript tool for transforming the text into speech.
 *  Author: Marius OLAR
 *  Version: 1.0
...
function text_to_speech_style_for_front_end() {
	echo'
	<script src="'.get_bloginfo('siteurl').'/wp-content/plugins/text-to-speech/espeak/speakGenerator.js"></script>
	<script src="'.get_bloginfo('siteurl').'/wp-content/plugins/text-to-speech/espeak/speakClient.js"></script>
	<script src="'.get_bloginfo('siteurl').'/wp-content/plugins/text-to-speech/espeak/speakWorker.js"></script>
	<script src="'.get_bloginfo('siteurl').'/wp-content/plugins/text-to-speech/espeak/speak.js"></script>
	';
}

add_action('wp_head', 'text_to_speech_style_for_front_end');
